...
class InterventionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create intervention" do
    assert_difference('Intervention.count') do
      post interventions_url, params: { intervention: { complete: @intervention.complete, concern: @intervention.concern, follow_up: @intervention.follow_up, frequency: @intervention.frequency, goal: @intervention.goal, name: @intervention.name, occured: @intervention.occured, sub_concern: @intervention.sub_concern, when: @intervention.when, where: @intervention.where, working: @intervention.working } }
    end
  ...
  test "should update intervention" do
    patch intervention_url(@intervention), params: { intervention: { complete: @intervention.complete, concern: @intervention.concern, follow_up: @intervention.follow_up, frequency: @intervention.frequency, goal: @intervention.goal, name: @intervention.name, occured: @intervention.occured, sub_concern: @intervention.sub_concern, when: @intervention.when, where: @intervention.where, working: @intervention.working } }
